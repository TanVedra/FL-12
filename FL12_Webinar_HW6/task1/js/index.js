...
$('header+div').css({ 'border': '3px double red', 'padding': '20px' });
...
$('li:first').css({ 'color': '#096ff5' });
$('li:gt(5)').css({ 'color': '#ccc' });
$('ul:parent').css({ 'display': 'block', 'border': '1px solid green' });
...
$('img:first').closest('div').css({ 'border': '1px solid red', 'float': 'left' });